...
export default function BmiSection() {
  return (
    ...
    >
      <div className=" flex w-1/3 flex-col justify-between rounded-[10px] bg-main-orange-500 p-10">
        <h3 className="text-center text-2xl font-bold text-white">
          BMI Calculator
        </h3>
        <Input
          placeholder="Height (cm)"
          className="w-full py-6 placeholder:text-center focus-visible:ring-main-orange-500"
        />
        <Input
        ...
        <Button className="border-2 bg-inherit py-6 hover:bg-main-orange-700">
          Calculate
        </Button>
      </div>
